...
class ASUCI_ViewController: UIViewController,
 UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: s + "asuci"  + "%20ORDER%20BY%20eventDate%20ASC")
    ...
    func tableView(_ tableView: UITableView,
        ...
        UITableViewCell {
            ...
            let cell = self.tableView.dequeueReusableCell(withIdentifier: "customCell", for: indexPath) as! ASUCI_TableViewCell
